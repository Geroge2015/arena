...
public class SwitchButton extends CompoundButton {
    ...
    public static int DEFAULT_TINT_COLOR = MyApplication.getAppContext().getResources().getColor(R.color.nc_colorAccentBlue);
    ...
    private void setup() {
        ...
        float heightOffset = DimenUtils.dp2px(5);
        float widthOffset = DimenUtils.dp2px(5);
        ...
        mBackRectF.set(backLeft + widthOffset,
                mThumbRectF.top - mThumbMargin.top + heightOffset,
                backLeft + mThumbMargin.left + mThumbSizeF.x * mBackMeasureRatio + mThumbMargin.right - widthOffset,
                mThumbRectF.bottom + mThumbMargin.bottom - heightOffset);

        mSafeRectF.set(mThumbRectF.left,
                0,
                mBackRectF.right - mThumbMargin.right - mThumbRectF.width() + widthOffset,
                0);
    ...
    protected void onDraw(Canvas canvas) {
        // super.onDraw(canvas); // avoid exception on diff platform
...
//                break;
    ...
    public static ColorStateList generateThumbColorWithTintColor(final int tintColor) {
        ...
        int[] colors = new int[]{
                0xFFF1F1F1,
                0xFFF1F1F1, //0xFFBABABA,
                tintColor | 0xFF000000,
                tintColor | 0xFF000000,
                0xFF50B10C,  //tintColor | 0xFF000000,
                0xFFD8D8D8   //0xFFF1F1F1
        };
    ...
    public static ColorStateList generateBackColorWithTintColor(final int tintColor) {
        ...
        int[] colors = new int[]{
                ...
                0x20000000,
                0xFFA7D885, //tintColor - 0xD0000000,
                0xFF858585  //0x20000000
        };
        return new ColorStateList(states, colors);
    }
    ...
    public void onPopulateAccessibilityEvent(AccessibilityEvent event) {
        // do nothing, override this method is avoid exception on different platform
    }
}
